...
public interface NextpeerDelegate extends NSObjectProtocol {
   /**
...
//  -(void)nextpeerDidTournamentStartWithDetails:(NPTournamentStartDataContainer *)tournamentContainer;
   @Method(selector = "nextpeerDidTournamentStartWithDetails:")
...
//  -(void)nextpeerDidTournamentEnd;
   @Method(selector = "nextpeerDidTournamentEnd:")
...
// -(BOOL)nextpeerSupportsTournamentWithId:(NSString* )tournamentUuid;
   @Method(selector = "nextpeerSupportsTournamentWithId:")
...
//  -(BOOL)nextpeerNotSupportedShouldShowCustomError;
   @Method(selector = "nextpeerNotSupportedShouldShowCustomError:")
...
//  - (void)nextpeerWillTournamentStartWithDetails:(NPTournamentStartDataContainer *)tournamentContainer;
   @Method(selector = "nextpeerWillTournamentStartWithDetails:")
...
//  - (void)nextpeerDashboardWillAppear;
   @Method(selector = "nextpeerDashboardWillAppear:")
...
//  - (void)nextpeerDashboardDidAppear;
   @Method(selector = "nextpeerDashboardDidAppear:")
...
//  - (void)nextpeerDashboardWillDisappear;
   @Method(selector = "nextpeerDashboardWillDisappear:")
...
//  - (void)nextpeerDashboardDidDisappear;
   @Method(selector = "nextpeerDashboardDidDisappear:")
...
//  - (void)nextpeerDashboardDidReturnToGame;
   @Method(selector = "nextpeerDashboardDidReturnToGame:")
...
//  -(BOOL)shouldAllowInterGameScreen;
   @Method(selector = "shouldAllowInterGameScreen:")
...
//  -(void)nextpeerWillHideToShowInterGameScreen;
   @Method(selector = "nextpeerWillHideToShowInterGameScreen:")
